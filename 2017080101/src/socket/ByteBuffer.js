...
var ByteBuffer=function () {
    ...
    {
        this.buffer= new ArrayBuffer(limitLen);
        this.view = new DataView(this.buffer);
        this.offset=0;
        this.count=0;
        this.length=limitLen;
    };
    this.initBlank2=function()
    {
        limitLen=1024*1024;
        this.buffer= new ArrayBuffer(limitLen);
        this.view = new DataView(this.buffer);
    ...
    this.initBlank3=function(buf)
    {
        this.buffer= buf;//new ArrayBuffer(1024*1024*1024);
        this.view = new DataView(this.buffer);
        this.offset=0;
