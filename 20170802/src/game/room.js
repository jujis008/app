...
var RoomScene=cc.Layer.extend({
    ...
    ctor: function (sceneId) {
        ...
        var bgSp=new cc.Sprite("res/ui/room_fucheng/bg_room.png");
        ...
        var bar=new cc.Sprite("res/ui/room_pipi/banner_room.png");
        ...
        this.lineSp=new cc.Sprite("res/ui/room_pipi/line_room.png");
    ...
    initUI:function () {
        ...
        this.centerNode = parseUI("res/ui/room_pipi/center.json", CENTER);
        this.addChild(this.centerNode);
        this.wxButton = ccui.helper.seekWidgetByName(this.centerNode, "Button_1");
        if(this.roomInfo!=undefined&&this.roomInfo.roomUsers.length!=this.roomInfo.renshu)
        {
            this.wxButton.visible=true;
        }
        else{
        ...
        this.wxButton.addTouchEventListener(this.wxButtonClicked,this)
        ...
        this.roomBaseInfoUI = parseUI("res/ui/room_pipi/leftTop.json", LEFT_TOP);
        this.addChild(this.roomBaseInfoUI);


        this.operButtonUI = parseUI("res/ui/room_pipi/centerBottom.json", CENTER_BOTTOM);
        this.addChild(this.operButtonUI);
        var jiesan = ccui.helper.seekWidgetByName(this.operButtonUI, "jiesan");
        jiesan.visible=false;

        var msg = ccui.helper.seekWidgetByName(this.operButtonUI, "msg");
        msg.addTouchEventListener(this.msgClicked,this)

        var Button_31 = ccui.helper.seekWidgetByName(this.operButtonUI, "Button_31");
        Button_31.addTouchEventListener(this.setClicked,this)

        this.bottomUI = parseUI("res/ui/room_pipi/leftBottom.json", CENTER_BOTTOM);
        this.addChild(this.bottomUI,TABLE_DESKER_ZOEDER+3);

        this.leftUI = parseUI("res/ui/room_pipi/leftCenter.json", LEFT_CENTER);
        this.addChild(this.leftUI);

        this.rightUI = parseUI("res/ui/room_pipi/rightCenter.json", RIGHT_CENTER);
        this.addChild(this.rightUI);

        this.topUI = parseUI("res/ui/room_pipi/topCenter.json", CENTER_TOP);
    ...
    msgClicked:function(sender, type)
    {
        ...
        switch (type) {
            ...
            {
                var layer=new LiaoTianLayer(this);
    ...
    wxButtonClicked:function(sender, type)
    {
        ...
        switch (type) {
            case ccui.Widget.TOUCH_ENDED:
            {
                ...
                var str="房间号:"+this.roomInfo.roomId+",邵阳剥皮玩法,100胡结束,速度加入【玖久棋牌跑胡子】";
                weixinShare("0",str);
            }
                break;
    ...
    updateHuXi:function(player)
    {
        ...
        if(player.uid==myPlayerInfo.uid)
        {
            if(player.state==1)
            {
                ...
                {
                    console.log("[开明胶]");
                    this.kaimingjiao=new cc.Sprite("res/ui/room_pipi/kaimingjiao_room.png");
        ...
        switch(msgNumber)
        {
            ...
            case ROOM_PLAYER_CARDS_NOTIFY:
            {
                ...
                for(var i=0;i<len;i++)
                {
                    ...
                    target.resetMyCardPos(roomUser,null);
                    ...
                    target.resetMyCardPos3(roomUser);
            ...
            case DISMISS_NOTIFY:
            {
                ...
                target.addChild(target.jiesanLayer,TABLE_DESKER_ZOEDER+1);
            }
                break;
            case DISMISS_RESPONSE:
            {
                ...
                else if(body.state==2)
                {
                    ...
                    target.addChild(dialog,TABLE_DESKER_ZOEDER);
        ...
        if(isOnline)
        {
            ...
            if(roomUser!=undefined&&roomUser!=null&&this.offLineUser[uid]==undefined)
            {
               ...
               // var lab = new cc.LabelTTF("掉线", FONT_NAME_APP, 20);
                ...
                //lab.x=pos.x;
                //lab.y=pos.y;
                var labSp=new cc.Sprite("res/ui/room_pipi/lixian_room.png");
                labSp.x=pos.x;
                labSp.y=pos.y;
    ...
    updateDeskLeftCount:function () {
        ...
        {
            var sp=new cc.Sprite("res/ui/room_pipi/card_room.png");
            sp.y+=i*2;
   ...
   testAck:function (dt) {
    ...
    resetMyCardPos:function (roomUser,myCard) {
        ...
        else if(uiPos==RIGHT_UI)
        {
            ...
            var x=v_x+v_w-this.y_a;
            var y=v_y+v_h/2;


            var len=roomUser.colsLocal.length;
            var init_y=y-(len-1)/2*this.gap_h;
            ...
            for(var i=0;i<len;i++)
            {
                ...
                for(var j=0;j<size;j++)
                {
                    ...
                    var cardSprite=this.getCardSpriteByCardId(roomUser,card.c_id);
                    cardSprite.visible=false;
                    cardSprite.x=x-(j*this.gap_w);
                    cardSprite.y=init_y;
                    cardSprite.setLocalZOrder(size-j);
                    cardSprite.changeToSmall();
                    //if(OLD_CARD==1)
                    {
                        cardSprite.setScl(0.5);
                    }
        ...
        if(player.uid==myPlayerInfo.uid)
        {
            ...
            if(this.selectedLayer==undefined||this.selectedLayer==null)
            {
                ...
                if(action.type!=ACTION_KEHU2)
                {
                    ...
                    button.loadTextures("res/ui/room_pipi/close_room.png","res/ui/room_pipi/close_room.png","res/ui/room_pipi/close_room.png");
                    button.setScale(0.8);
            ...
            if(action.type==ACTION_KECHI)
            {
                if(this.selectedLayer.hasChi==undefined)
                {
                    ...
                    button.setTouchEnabled(true);
                    button.setPressedActionEnabled(true);
                    button.loadTextures("res/ui/room_pipi/chi_room.png","res/ui/room_pipi/chi_room.png","res/ui/room_pipi/chi_room.png");
                    button.setScale(0.8);
            ...
            else if(action.type==ACTION_KEPENG)
            {
                if(this.selectedLayer.hasPeng==undefined)
                {
                    ...
                    button.setTouchEnabled(true);
                    button.setPressedActionEnabled(true);
                    button.loadTextures("res/ui/room_pipi/peng_room.png","res/ui/room_pipi/peng_room.png","res/ui/room_pipi/peng_room.png");
                    button.setScale(0.8);
            ...
            else if(action.type==ACTION_KEHU||action.type==ACTION_KEHU2)
            {
                if(this.selectedLayer.hasHu==undefined)
                {
                    ...
                    button.setTouchEnabled(true);
                    button.setPressedActionEnabled(true);
                    button.loadTextures("res/ui/room_pipi/hu_room.png","res/ui/room_pipi/hu_room.png","res/ui/room_pipi/hu_room.png");
                    button.setScale(0.8);
    ...
    showClock:function (player,roomState) {
        ...
        if(NO_WAIT_TIME_OUT==1)
        {
            ...
            var sp=new cc.Sprite("res/ui/room_pipi/clock_room.png");
            sp.setScale(0.5);
            layer.addChild(sp);
            var txt = new cc.LabelTTF("20", FONT_NAME_APP, 25);
            txt.setColor(cc.color(255,255,255));
    ...
    actionWaitPut:function (player,action) {
        ...
        if(player.uid==myPlayerInfo.uid&&(this.shouSp==undefined||this.shouSp==null))
        {
            ...
            var sp=new cc.Sprite("res/ui/room_pipi/shou_room.png");
            this.shouSp.addChild(sp);

            var sp2=new cc.Sprite("res/ui/room_pipi/huadongchupai_room.png");
            this.shouSp.addChild(sp2);
            sp2.y=-20;


            this.shouSp.x=v_x+v_w-100;
            this.shouSp.y=v_y+100;
            this.addChild(this.shouSp,TABLE_DESKER_ZOEDER);
    ...
    actionUpdate:function (dt) {
        ...
        while(this.wordQueue.length>0&&this.wordShowCount==0)
        {
            ...
            switch(obj.type){
                case WORLD_CHI:
                {
                    sp=new cc.Sprite("res/ui/room_pipi/zchi_room.png");
                }
                    break;
                case WORLD_HU:
                {
                    sp=new cc.Sprite("res/ui/room_pipi/zhu_room.png");
                }
                    break;
                case WORLD_PAO:
                {
                    sp=new cc.Sprite("res/ui/room_pipi/zpao_room.png");
                }
                    break;
                case WORLD_PENG:
                {
                    sp=new cc.Sprite("res/ui/room_pipi/zpeng_room.png");
                }
                    break;
                case WORLD_TI:
                {
                    sp=new cc.Sprite("res/ui/room_pipi/zti_room.png");
                }
                    break;
                case WORLD_WEI:
                {
                    sp=new cc.Sprite("res/ui/room_pipi/zwei_room.png");
                }
                    break;
                case WORLD_BI:
                {
                    sp=new cc.Sprite("res/ui/room_pipi/bi_room.png");
                }
                    break;
                case WORLD_HUANGZHUANG:
                {
                    sp=new cc.Sprite("res/ui/room_pipi/huangzhuang_room.png");
                }
                    break;
                case WORLD_BU:
                {
                    sp=new cc.Sprite("res/ui/room_pipi/bu_room.png");
                }
                    break;
                case WORLD_TIAN_HU:
                {
                    sp=new cc.Sprite("res/ui/room_pipi/tianhu_room.png");
                }
                    break;
                case WORLD_DI_HU:
                {
                    sp=new cc.Sprite("res/ui/room_pipi/dihu_room.png");
                }
                    break;
                case WORLD_ZI_MO:
                {
                    sp=new cc.Sprite("res/ui/room_pipi/zimo_room.png");
                }
                    break;
